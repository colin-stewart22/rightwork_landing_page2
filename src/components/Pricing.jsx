  ...
  return (
    <section
      className={clsx(
        ...
        featured ? 'order-first bg-blue-600 py-8 lg:order-none' : 'lg:py-8 border border-white border-2 py-8'
      )}
    >
      ...
      <p className="order-first font-display text-3xl lg:text-4xl font-light tracking-tight text-white">
        {price}
      </p>
      <ul
        role="list"
        ...
        <div className="flex flex-col md:flex-row justify-center items-center md:items-stretch gap-16 -mx-4 mt-16">
          <div className="w-9/12 md:w-1/3">
            <Plan
              ...
              price="Business"
              description="Optimized scheduling designed for scaling companies."
              href="/register"
              features={[
                'Employee scheduling',
          ...
          <div className="w-9/12 md:w-1/3">
            <Plan
              name="200+ locations"
              price="Enterprise"
              description="More customizable options for established companies."
              href="/register"
              features={[
                'Employee scheduling',
                'Auto-scheduling and auto-tuning',
