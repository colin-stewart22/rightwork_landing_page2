...
export function Testimonial() {
  return(
    <section className="relative isolate overflow-hidden bg-white py-24 px-6 sm:py-32 lg:px-8">
      ...
      <div className="absolute inset-y-0 right-[45%] -z-10 mr-16 w-[200%] origin-bottom-left skew-x-[-30deg] bg-white shadow-xl shadow-indigo-600/10 ring-1 ring-indigo-50 sm:mr-28 lg:mr-0 xl:mr-16 xl:origin-center" />
      <div className="mx-auto max-w-2xl lg:max-w-4xl">
        ...
        <figure className="mt-8">
          <blockquote className="text-center text-xl font-semibold leading-8 text-gray-900 sm:text-2xl sm:leading-9">
            <p>
              “This is a placeholder for a testimonial. It is supposed to relay credibility to a potential buyer and inspire them to try the software product.”
            </p>
          </blockquote>
          <figcaption className="mt-10">
            {/* <div className="mx-auto h-10 w-10 rounded-full bg-red-200"></div> */}
            <div className="mt-4 flex items-center justify-center space-x-3 text-base">
              <div className="font-semibold text-gray-900">Lars Lastname</div>
